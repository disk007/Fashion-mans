    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                ...
                ?>
                        <hr>
                        <a href="detail_order.php?id=<?php echo $id_code; ?>">ดูรายละเอียด</a><br>
                        <div style="font-size:18px;font-weight: bold;">รหัสการสั่งซื้อ <?php echo $values['id_order']; ?></div>
                        <div><?php
                                    if ($values['Status'] == "ยังไม่ชำระ") {
                    ...
                    ?>
                    <?php echo "<tr><img src=../image/product/$values[Picture] width=15%></tr>"; ?>
                <?php
