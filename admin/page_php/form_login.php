      ...
      <div class="col form-login">
        <div id="form_login" class=" p-4 max-w-md bg-white rounded-lg border border-gray-200 shadow-md md:p-5 lg:p-8 dark:bg-gray-800 dark:border-gray-700">
          <form class="space-y-6" action="../php/check_login.php" method="POST">
            <h3 class="text-center text-xl font-medium text-gray-900 dark:text-white m-1">ลงชื่อเข้าใช้งาน</h3>
            <h3 class="text-center text-md font-medium text-gray-900 text-danger m-0 p-0">สำหรับแอดมินเท่านั่น</h3>
            <div>
              <label for="username" class="block mb-2 text-md font-medium text-gray-900 dark:text-gray-300">บัญชีผู้ใช้</label>
              <input type="text" name="P_Username" id="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-md rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="กรุณากรอกชื่อผู้ใช้งาน" required="">
            </div>
            <div>
              <label for="password" class="block mb-2 text-md font-medium text-gray-900 dark:text-gray-300">รหัสผ่าน</label>
              <input type="password" id="password" name="P_Password" placeholder="••••••••••••" class="bg-gray-50 border border-gray-300 text-gray-900 text-md rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" required="">
            </div>
            ...
            <button type="submit" name="A_login" class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-md px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Login to your account</button>
