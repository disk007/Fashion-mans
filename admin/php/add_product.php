    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    ...
                    <div class="ms-3 pt-2">
                        <h5 class="mb-0 text-primiry">Admin</h5>
                        <span>James&Dis</span>
                    </div>
                </div>
        ...
        <div class="content">
            ...
            <div class="row justify-content-center">
                <form class=" col col-md-5 " action="process_add.php" method="post" enctype="multipart/form-data">
                    <div class="">
                    ...
                    <div class="row  d-flex  ">
                            <div class="col-3"> Size : S
                                <input type="text" class="form-control" placeholder="จำนวน" name="Amount_S"> </div><div class="col-3">
                          
                                Size : M<input type="text" class="form-control" placeholder="จำนวน" name="Amount_M"></div><div class="col-3">
                                Size : L<input type="text" class="form-control" placeholder="จำนวน" name="Amount_L"></div><div class="col-3">
                                Size : XL<input type="text" class="form-control" placeholder="จำนวน" name="Amount_XL"></div>
                    ...
                    <div class="">
                        ...
                        <input type="text" class="form-control" name="Price" id="Price" name="Price" required>
                        <label for="Type">ชนิดเสื้อ</label>
                        <input type="text" class="form-control" name="Type" id="Type" name="Type" required>
                    </div>

                    <label>รูปภาพ</label>
                    <input type="file" style="cursor: 
                    pointer;" class="form-control" name="Picture" accept="image/*">
                    ...
                    <div class="">
                        ...
                        <textarea class="form-control" class="detail" id="Detail" rows="10" name="Detail" required></textarea>
                    </div>
                    <div class="p-3">
                        <button type="submit" name="add" class="btn btn-outline-primary">เพิ่มสินค้า</button>
                    </div>
                </form>
            </div>
            <!-- 404 End -->
